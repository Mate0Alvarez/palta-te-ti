    ...
    for (var i = 0; i < options.length; i++) {
      options[i].onclick = function(){
        ...
        if (this.parentNode.querySelector("input").value == 0) {
          var player = "<img src='img/welcome-avocado.png' alt='palta saludando.' >";
          var computer = "<img src='img/cross.png' alt='iluestración de una cruz.'>";
        } else {
          var computer = "<img src='img/welcome-avocado.png' alt='palta saludando.'>";
          var player = "<img src='img/cross.png' alt='iluestración de una cruz.'>";
        }
